...
import { getLiveSiteControlProperty } from '../../common/utils/gdlLiveSiteControlDataHelpers';
...
export default function AddDomain() {
	...
	const renderStepText = () => {
		return (
			<p>
				{ addDomainComplete ? getLiveSiteControlProperty( 'siteUrl' ) : __( 'Choose the domain you used before, or another one if you prefer', 'godaddy-launch' ) }
			</p>
		);
	};
